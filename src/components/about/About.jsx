...
import Curriculo from "../../assets/Curriculo_Victor_Fullstack.pdf";
    ...
    <section className='about section' id='about'>
      ...
      <div className='sobre_container container grid'>
        ...
        <div className="sobre_data">
          <Info />
          <p className="sobre_description">Sou desenvolvedor
            FullStack há 3 anos,
            recentemente trabalhei
            como Analista de
            desenvolvimento software.
            Já trabalhei em diferentes
            projetos com diferentes
            níveis de dificuldade.
            Domino tecnologias como
            Java, Python, React, Node e
            muitas outras
            . </p>
